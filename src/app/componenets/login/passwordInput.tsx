    ...
    return (
        <div className='mb-4 grid w-full relative'>
            ...
            <div className='relative'>
                <input ref={toggleVisibility} id="password" name="password" type={isVisible ? 'text' : 'password'} className='border rounded-lg p-2 bg-white focus-within:outline w-full' autoComplete="new-password"/>
                <button type='button' className='absolute right-3 top-2' onClick={() => setTogglePassword(!isVisible)}>
                    {isVisible ?
