    ...
    return (
        <header className="fixed pb-2 lg:py-0 lg:sticky left-0 right-0  top-0 z-50 bg-blue-500 ">
            <section className='bg-ui-red '>
                <div className='container mx-auto gap-4  items-center py-1 text-white text-sm whitespace-nowrap text-right overflow-auto flex '>
                    {'Dziś gabinet jest zamknięty,'} <Link href="/#otwarte">sprawdź najbliższe godziny otwarcia</Link>
                    </div>
