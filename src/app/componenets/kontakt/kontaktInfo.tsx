...
export default function KontaktInfo() {
    ...
    return (
        <div className='mb-12'>
            ...
            <a className="mt-2 mb-4 block btn-ui btn-second  max-w-max" href="https://goo.gl/maps/5vwZ1Veo9Y9zDGsC9" target="_blank">{t('navigate')}</a>
            ...
            <a className="mt-2 block   btn-ui btn-second max-w-max" href="http://wa.me/48506109445/?text=Dzień dobry, chciałbym umówić się na wizytę" target="_blank">WhatsApp</a>
        </div>
    )
}