                                        ...
                                        <div className='card bg-base-100  border'>
                                            <div className='card-body'>
                                                ...
                                                <div className='flex gap-3 mb-3'>
                                                    <span className='min-w-[130px] '>{t('date')}:</span> <span className='font-semibold'>{'2024-05-01'}</span>
                                                </div>
                                                <div className='flex gap-3 mb-3'>
                                                    <span className='min-w-[130px] '>{t('hour')}:</span> <span className='font-semibold'>{'10:30'}</span>
                                                </div>
                                                <div className='flex gap-3 mb-3'>
